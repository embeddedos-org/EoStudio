...
class ImageEditor(tk.Frame):
    """Raster/vector image editor with layers, brushes, and filters."""
    ...
    def _build_ui(self) -> None:
        header = tk.Label(self, text="Image Editor", bg=self._bg, fg=self._fg, font=("Segoe UI", 12, "bold"))
