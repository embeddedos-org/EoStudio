...
class Modeler3DEditor(tk.Frame):
    """3D scene modeler with viewport, hierarchy panel, and properties."""
    ...
    def _build_ui(self) -> None:
        header = tk.Label(self, text="3D Modeler", bg=self._bg, fg=self._fg, font=("Segoe UI", 12, "bold"))
