...
class DatabaseEditor(tk.Frame):
    """Visual database schema designer with ERD and SQL generation."""
    ...
    def _build_ui(self) -> None:
        header = tk.Label(self, text="Database Editor", bg=self._bg, fg=self._fg, font=("Segoe UI", 12, "bold"))
