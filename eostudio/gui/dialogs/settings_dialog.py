...
class SettingsDialog(tk.Toplevel):
    ...
    def _build_ui(self) -> None:
        tk.Label(self, text="Settings", bg=self._bg, fg=self._fg, font=("Segoe UI", 14, "bold")).pack(
        ...
        tk.Label(general, text="Theme:", bg=self._bg, fg=self._fg, font=("Segoe UI", 10)).pack(
            anchor=tk.W, padx=12, pady=(12, 4)
        )
        self._theme_var = tk.StringVar(value="dark")
        ttk.Combobox(general, textvariable=self._theme_var, values=["dark", "light"], state="readonly", width=14).pack(
            anchor=tk.W, padx=12
        )

        ai_frame = tk.Frame(nb, bg=self._bg)
        nb.add(ai_frame, text="AI / LLM")
        tk.Label(ai_frame, text="Endpoint:", bg=self._bg, fg=self._fg, font=("Segoe UI", 10)).pack(
            anchor=tk.W, padx=12, pady=(12, 4)
        )
        ...
        tk.Label(ai_frame, text="Model:", bg=self._bg, fg=self._fg, font=("Segoe UI", 10)).pack(
