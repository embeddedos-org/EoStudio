...
# -- Monokai --
BUILTIN_THEMES["monokai"] = _make_theme(
    "monokai",
    "#272822",
    "#F8F8F2",
    {
...
# -- One Dark --
BUILTIN_THEMES["one_dark"] = _make_theme(
    "one_dark",
    "#282C34",
    "#ABB2BF",
    {
...
# -- Solarized Dark --
BUILTIN_THEMES["solarized_dark"] = _make_theme(
    "solarized_dark",
    "#002B36",
    "#839496",
    {
...
# -- Solarized Light --
BUILTIN_THEMES["solarized_light"] = _make_theme(
    "solarized_light",
    "#FDF6E3",
    "#657B83",
    {
...
# -- Dracula --
BUILTIN_THEMES["dracula"] = _make_theme(
    "dracula",
    "#282A36",
    "#F8F8F2",
    {
...
# -- GitHub Light --
BUILTIN_THEMES["github_light"] = _make_theme(
    "github_light",
    "#FFFFFF",
    "#24292E",
    {
...
# -- GitHub Dark --
BUILTIN_THEMES["github_dark"] = _make_theme(
    "github_dark",
    "#0D1117",
    "#C9D1D9",
    {
...
# -- Nord --
BUILTIN_THEMES["nord"] = _make_theme(
    "nord",
    "#2E3440",
    "#D8DEE9",
    {
...
# -- Catppuccin (Mocha) --
BUILTIN_THEMES["catppuccin"] = _make_theme(
    "catppuccin",
    "#1E1E2E",
    "#CDD6F4",
    {
...
# -- Gruvbox --
BUILTIN_THEMES["gruvbox"] = _make_theme(
    "gruvbox",
    "#282828",
    "#EBDBB2",
    {
...
# -- Tokyo Night --
BUILTIN_THEMES["tokyo_night"] = _make_theme(
    "tokyo_night",
    "#1A1B26",
    "#A9B1D6",
    {
...
# -- Material Dark --
BUILTIN_THEMES["material_dark"] = _make_theme(
    "material_dark",
    "#263238",
    "#EEFFFF",
    {
...
_LANG_CSHARP = LanguageDefinition(
    ...
    patterns=[
        ...
        (
            TokenType.PREPROCESSOR,
            r"#\s*(?:if|elif|else|endif|define|undef|warning|error|line|region|endregion|pragma|nullable)\b[^\n]*",
        ),
        (TokenType.STRING, r'@"(?:[^"]|"")*"'),
        (TokenType.STRING, r'\$"(?:[^"\\]|\\.|\{[^}]*\})*"'),
        (TokenType.STRING, r'"(?:[^"\\]|\\.)*"'),
...
_LANG_CSS = LanguageDefinition(
    ...
    patterns=[
        ...
        (
            TokenType.NUMBER,
            r"-?\d+\.?\d*(?:px|em|rem|%|vh|vw|vmin|vmax|ch|ex|cm|mm|in|pt|pc|deg|rad|grad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx|fr)?",
        ),
        (TokenType.VARIABLE, r"--[\w-]+"),
        (TokenType.VARIABLE, r"\$[\w-]+"),
...
_LANG_MAKEFILE = LanguageDefinition(
    ...
    patterns=[
        ...
        (
            TokenType.KEYWORD,
            r"\b(?:ifeq|ifneq|ifdef|ifndef|else|endif|include|sinclude|override|export|unexport|define|endef|vpath)\b",
        ),
        (TokenType.BUILTIN, r"\$\([^)]+\)"),
        (TokenType.BUILTIN, r"\$\{[^}]+\}"),
        (TokenType.BUILTIN, r"\$[@<^+?*%]"),
