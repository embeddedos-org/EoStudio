...
class AnimationPreset:
    ...
    def apply(self, target_id: str, delay: float = 0.0, duration: Optional[float] = None) -> AnimationClip:
        d = duration or self.duration
        clip = AnimationClip(target_id=target_id, duration=d, delay=delay, fill_mode=FillMode.FORWARDS, label=self.name)
