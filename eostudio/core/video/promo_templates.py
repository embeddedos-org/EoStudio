...
class PromoTemplate:
    ...
    @classmethod
    def from_aspect_ratio(cls, name: str, preset: str, duration: float = 5.0, **kwargs: Any) -> "PromoTemplate":
        ...
        return cls(
            name=name, category="social", width=dims["width"], height=dims["height"], duration=duration, **kwargs
        )
    ...
    def create_compositor(self, **overrides: Any) -> VideoCompositor:
        ...
        for lc in self.layers_config:
            ...
            transform = LayerTransform(
                ...
                width=transform_data.get("width", 100),
                height=transform_data.get("height", 100),
...
_register(
    PromoTemplate(
        ...
        variables={"headline": "Introducing", "product_name": "Product", "cta": "Try it now"},
        layers_config=[
            {
                "id": "bg",
                "name": "Background",
            ...
            },
            {
                ...
                "name": "Headline",
                "type": "text",
                "content": {"text": "{headline}", "font_size": 32, "color": "#94a3b8", "font_weight": 500},
            ...
            },
            {
                ...
                "name": "Product Name",
                "type": "text",
                "content": {"text": "{product_name}", "font_size": 64, "color": "#f1f5f9", "font_weight": 800},
            ...
            },
            {
                ...
                "name": "CTA",
                "type": "text",
                "content": {"text": "{cta}", "font_size": 28, "color": "#3b82f6", "font_weight": 600},
    ...
    PromoTemplate(
        ...
        layers_config=[
            ...
            },
            {
                ...
                "name": "Product Name",
                "type": "text",
                "content": {"text": "{product_name}", "font_size": 96, "color": "#ffffff", "font_weight": 800},
                "start": 0,
                "end": 4,
            ...
            },
            {
                ...
                "name": "CTA",
                "type": "text",
                "content": {"text": "{url}", "font_size": 42, "color": "#3b82f6", "font_weight": 600},
                "start": 13,
                "end": 15,
                "transform": {"x": 960, "y": 540},
            },
    ...
    PromoTemplate(
        ...
        layers_config=[
            ...
            },
            {
                ...
                "name": "Title",
                "type": "text",
                "content": {"text": "{title}", "font_size": 48, "color": "#f1f5f9", "font_weight": 700},
    ...
    PromoTemplate(
        ...
        layers_config=[
            ...
            },
            {
                ...
                "name": "Headline",
                "type": "text",
                "content": {"text": "{headline}", "font_size": 42, "color": "#1f2937", "font_weight": 700},
...
_register(
    PromoTemplate(
        ...
        variables={"product": "Product Name", "tagline": "One line description", "emoji": "rocket"},
        layers_config=[
            {
                "id": "bg",
                "name": "Background",
            ...
            },
            {
                ...
                "name": "Product",
                "type": "text",
                "content": {"text": "{product}", "font_size": 56, "color": "#1f2937", "font_weight": 800},
    ...
    PromoTemplate(
        ...
        layers_config=[
            ...
            },
            {
                ...
                "name": "Tagline",
                "type": "text",
                "content": {"text": "{tagline}", "font_size": 32, "color": "#a0a0a0", "text_align": "center"},
                "start": 1,
                "end": 5,
...
_register(
    PromoTemplate(
        ...
        variables={"title": "Demo", "code_snippet": "const app = new App();", "browser_url": "https://myapp.com"},
        layers_config=[
            {
                "id": "bg",
                "name": "Background",
            ...
            },
            {
                ...
                "name": "Code Area",
                "type": "text",
                "content": {"text": "{code_snippet}", "font_size": 16, "color": "#cdd6f4", "font_family": "monospace"},
                "start": 2,
                "end": 18,
    ...
    PromoTemplate(
        ...
        layers_config=[
            ...
            # Intro
            {
                ...
                "name": "Product Name",
                "type": "text",
                "content": {"text": "{product_name}", "font_size": 96, "color": "#f8fafc", "font_weight": 800},
                "start": 0,
                "end": 5,
            ...
            # Feature demos
            {
                ...
                "name": "Feature 1",
                "type": "text",
                "content": {"text": "{feature_1}", "font_size": 48, "color": "#f8fafc", "font_weight": 700},
                "start": 5,
                "end": 12,
            ...
            },
            {
                ...
                "name": "Feature 2",
                "type": "text",
                "content": {"text": "{feature_2}", "font_size": 48, "color": "#f8fafc", "font_weight": 700},
                "start": 12,
                "end": 19,
                "transform": {"x": 300, "y": 100},
            },
            ...
            },
            {
                ...
                "name": "Feature 3",
                "type": "text",
                "content": {"text": "{feature_3}", "font_size": 48, "color": "#f8fafc", "font_weight": 700},
                "start": 19,
                "end": 26,
                "transform": {"x": 300, "y": 100},
            },
            ...
            # CTA
            {
                ...
                "name": "CTA",
                "type": "text",
                "content": {"text": "Try it now", "font_size": 56, "color": "#f8fafc", "font_weight": 800},
                "start": 26,
                "end": 30,
            ...
            },
            {
                ...
                "name": "URL",
                "type": "text",
                "content": {"text": "{url}", "font_size": 32, "color": "#3b82f6", "font_weight": 600},
                "start": 26,
                "end": 30,
                "transform": {"x": 960, "y": 540},
            },
