...
class WasmGenerator:
    ...
    def _gen_rust(self, screens: List[Dict[str, Any]], app_name: str) -> Dict[str, str]:
        files: Dict[str, str] = {}
    ...
    def _rust_elements(self, components: List[Dict[str, Any]], indent: int) -> str:
        lines: List[str] = []
        pad = "    " * indent
    ...
    def _gen_assemblyscript(self, screens: List[Dict[str, Any]], app_name: str) -> Dict[str, str]:
        files: Dict[str, str] = {}
        snake = self._snake(app_name)
        ...
        files["assembly/index.ts"] = "export function main(): void {\n" + "\n".join(body_lines) + "\n}\n\nmain();\n"
